...
fn mr_roboto(instructions: &[&str]) -> (i32, i32) {
    // The Lazy iterator is created with the iter method call. This is what is created with the iter() method call.
    // This data structure allows for the later processing to be sort of
    ...
    // the logic of this algorithm is able to be broken up while retaining
    // the same optimal time complexity.
    return instructions
        .iter()
